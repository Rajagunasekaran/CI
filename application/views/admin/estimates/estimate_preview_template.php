  ...
  <div class="panel-body">
   ...
   <div class="col-md-9">
     <div class="pull-right">
      ...
      <a href="<?php echo admin_url('estimates/pdf/'.$estimate->id.'?print=true'); ?>" target="_blank" class="btn pull-left btn-default mright5" data-toggle="tooltip" title="<?php echo _l('print'); ?>" data-placement="bottom"><i class="fa fa-print"></i></a>
