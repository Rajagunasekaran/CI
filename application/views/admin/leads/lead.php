...
<div class="tab-content">
	...
	<div role="tabpanel" class="tab-pane" id="lead_reminders">
		<a href="#" data-toggle="modal" data-target=".reminder-modal"><i class="fa fa-bell-o"> <?php echo _l('lead_set_reminder_title'); ?></i></a>
	...
	init_datepicker();
		<?php if(isset($lead)){ ?>
			...
			init_rel_tasks_table(<?php echo $lead->id; ?>,'lead','undefined','.table-rel-tasks-leads');
