...
<div class="col-lg-12">
	...
	<div class="alert alert-info alert-dismissible announcement" role="alert">
		...
		<h4 class="bold"><?php echo _l('announcement'); ?>! <?php if($__announcement['showname'] == 1){ echo _l('announcement_from').' '. $__announcement['firstname'] . ' ' .$__announcement['lastname']; } ?><br /><small>Added: <?php echo _dt($__announcement['dateadded']); ?></small></h5>
