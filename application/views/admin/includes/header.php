<div id="header">
  ...
  <nav>
   ...
   <div class="mobile-menu">
    ...
    <li>
      <a href="#" class="dropdown-toggle top-timers" data-toggle="dropdown"><i class="fa fa-clock-o"></i></a>
      ...
      <a href="<?php echo admin_url($notification['link']); ?>">
        ...
        <div class="notification-box<?php if($notification['isread'] == 0){echo ' unread';} ?>">
          ...
          if(($notification['fromcompany'] == NULL && $notification['fromuserid'] != 0) || ($notification['fromcompany'] == NULL && $notification['fromclientid'] != 0)){
            ...
            echo '<img src="'.client_profile_image_url($notification['fromclientid']).'" class="client-profile-image-small img-circle pull-left">';
          }
        }
        ?>
        <div class="media-body">
          ...
          if(($notification['fromcompany'] == NULL && $notification['fromuserid'] != 0) || ($notification['fromcompany'] == NULL && $notification['fromclientid'] != 0)){
           if($notification['fromuserid'] != 0){
            ...
            $description = get_client_full_name($notification['fromclientid']). ' - ' . $description . '<br /><span class="label inline-block mtop5 label-info">'._l('is_customer_indicator').'</span>';
          }
        }
        echo $description; ?><br />
