						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="col-md-12 row">
									...
									<?php echo render_select('userid',$clients,array('userid','company'),'ticket_settings_client',$selected,array('data-toggle'=>'tooltip','title'=>'ticket_settings_select_client')); ?>
								</div>
								<div class="col-md-12 row">
