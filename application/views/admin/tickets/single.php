												...
												<tbody>
													...
													<tr>
														...
														<td align="right" width="25">
															<?php if($note['admin'] == get_staff_user_id() || is_admin()){ ?>
								...
								<div role="tabpanel" class="tab-pane <?php if($this->session->flashdata('active_tab_settings')){echo 'active';} ?>" id="settings">
									<div class="row">
										<div class="col-md-6">
											...
											<div class="col-md-12 row">
												<?php echo render_select('userid',$clients,array('userid','company'),'ticket_settings_client',$ticket->userid,array('data-toggle'=>'tooltip','title'=>'ticket_settings_select_client')); ?>
											</div>
											<div class="col-md-12 row">
	...
	<div class="modal-dialog modal-lg" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php $this->load->view('admin/editor/template',array('name'=>'data','contents'=>'','editor_name'=>'ticket-message')); ?>
			</div>
...
<script>
	...
	function edit_ticket_message(id,type){
		...
		Ticket_message_editor.setHTML(message);
	...
	function init_ticket_edit_editor(){
		...
		Ticket_message_editor = new Quill('.editor-container-ticket-message', {
			modules: {
				'toolbar': {
					container: '.toolbar-container-ticket-message'
				},
				'link-tooltip': true,
				'image-tooltip': true,
				'multi-cursor': true
		...
		Ticket_message_editor.on('text-change', function(delta, source) {
			data = Ticket_message_editor.getHTML();
			$('.editor_change_contents-ticket-message').val(data);
		});
		Ticket_message_editor.setHTML($('.editor_contents-ticket-message').html());
	}
</script>
</body>
</html>
