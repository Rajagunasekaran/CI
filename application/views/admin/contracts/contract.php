					...
					<div class="panel-body">
						...
						<div class="form-group">
							<div class="checkbox checkbox-primary">
								<input type="checkbox" name="trash" data-toggle="tooltip" title="<?php echo _l('contract_trash_tooltip'); ?>" <?php if(isset($contract)){if($contract->trash == 1){echo 'checked';}}; ?>>
						...
						<?php echo render_select('client',$clients,array('userid','company'),'contract_client_string',$selected); ?>
