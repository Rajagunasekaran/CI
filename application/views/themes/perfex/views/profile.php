<div class="row">
<div class="col-md-8">
	<?php echo form_open_multipart('clients/profile'); ?>
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-md-6">
					...
					<?php if($client->profile_image == NULL){ ?>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-9">
									<img src="<?php echo client_profile_image_url($client->userid,'thumb'); ?>" class="client-profile-image-thumb">
								</div>
